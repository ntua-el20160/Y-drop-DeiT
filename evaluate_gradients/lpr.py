...
class LRP(GradientAttribution):
    ...
    def attribute(
        ...
        selected_layers: Optional[List[Module]] = None,

        verbose: bool = False,
    ) -> Union[
        TensorOrTupleOfTensorsGeneric,
        Tuple[TensorOrTupleOfTensorsGeneric, Tensor],
        Tuple[TensorOrTupleOfTensorsGeneric, Dict[Module, Tensor]],
        Tuple[TensorOrTupleOfTensorsGeneric, Tensor, Dict[Module, Tensor]],
    ]:
        r"""
        Args:
